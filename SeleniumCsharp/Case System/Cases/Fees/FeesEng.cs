...
namespace JUSTDEVELOPMENT.Case_System.Cases.Fees_Eng
{
    [TestFixture]
    [Parallelizable(ParallelScope.Fixtures)]
    [AllureNUnit]
    [AllureSuite("Fees Page")]
    [AllureFeature("Fees Page")]
    [AllureEpic("Case System features")]
    public class TestsFees
    {
        ...
        public void FeesPage()
        {
            ...
            // Fees >>
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[5]/li/a")));
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[5]/li/a")).Click();
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[5]/li/a")).Click();
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[5]/li/a")).Click();
            ...
            driver.FindElement(By.Id("AMOUNT")).SendKeys("350");
            driver.FindElement(By.Id("FINANCIALRECEIPTNO")).SendKeys("32");
            driver.FindElement(By.Id("ABOUT")).SendKeys("About Fees");


            //Date >>
            IWebElement REGISTRATIONDATEAr = driver.FindElement(By.Id("REGISTRATIONDATE"));
            REGISTRATIONDATEAr.Clear();
            REGISTRATIONDATEAr.Clear();
            REGISTRATIONDATEAr.SendKeys("21/12/2023");
            ...
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.Id("AMOUNT")));
            Thread.Sleep(3000);
            driver.FindElement(By.Id("AMOUNT")).Clear();
            driver.FindElement(By.Id("AMOUNT")).SendKeys("370");
            Thread.Sleep(5000);
            ...
            driver.FindElement(By.Id("FINANCIALRECEIPTNO")).SendKeys("26");
            driver.FindElement(By.XPath("//button[normalize-space()='EDIT']")).Click();
            Thread.Sleep(5000);
