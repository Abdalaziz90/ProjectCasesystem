...
namespace JUSTDEVELOPMENT.Case_System.Cases.LICENSE_OFFICER
{
    [TestFixture]
    ...
    public class TestsLICENSEOFFICERArabic
    {
        ...
        public void LICENSEOFFICERPage()
        {
            ...
            driver.FindElement(By.Id("ENNAME")).SendKeys("الانجليزي");
            Thread.Sleep(5000);
            ...
            driver.FindElement(By.Id("ARNAME")).SendKeys("العربي");
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("//button[contains(text(),'تعديل')]")).Click();
            Thread.Sleep(5000);
            ...
            // Report >>
            Thread.Sleep(5000);
            bool btnReport = driver.FindElement(By.XPath("//button[contains(text(),'تقرير')]")).Displayed;
