...
namespace JUSTDEVELOPMENT.Case_System.Cases.LICENSE_OFFICER_Eng
{
    [TestFixture]
    [Parallelizable(ParallelScope.Fixtures)]
    [AllureNUnit]
    [AllureSuite("LICENSE OFFICER Page")]
    [AllureFeature("LICENSE OFFICER Page")]
    [AllureEpic("Case System features")]
    public class TestsLICENSEOFFICER
    {
        ...
        [AllureStory("")]
        [AllureStep("")]
        public void LICENSEOFFICERPage()
        {
            ...
            // License Officer >>
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[9]/li/a")));
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[9]/li/a")).Click();
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[9]/li/a")).Click();
            driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/aside/div[2]/nav/ul/li[8]/ul/li/ul[9]/li/a")).Click();
            ...
            driver.FindElement(By.Id("ARNAME")).SendKeys("Arabic Name");
            driver.FindElement(By.Id("ENNAME")).SendKeys("English Name");
            driver.FindElement(By.Id("EMAIL")).SendKeys("****@yahoo.com");
            driver.FindElement(By.Id("MOBILE")).SendKeys("07xxxxxxxx");
            driver.FindElement(By.Id("OTHERMOBILE")).SendKeys("07xxxxxxxx");
            ...
            driver.FindElement(By.Id("ENNAME")).SendKeys("english");
            Thread.Sleep(5000);
            ...
            driver.FindElement(By.Id("ARNAME")).SendKeys("Arabic");
            driver.FindElement(By.XPath("//button[normalize-space()='EDIT']")).Click();
            Thread.Sleep(5000);
            ...
            // Report >>
            Thread.Sleep(5000);
            bool btnReport = driver.FindElement(By.XPath("//*[@id=\"app\"]/div[2]/main/div[2]/div/div/div[2]/button[2]")).Displayed;
            Assert.That(btnReport, Is.True);
            Thread.Sleep(5000);
