...
namespace JUSTDEVELOPMENT.Case_System.Cases.Client_Eng
{
    ...
    public class TestsClient
    {
        ...
        public void ClientPage()
        {
            ...
            String[] LicenseOfficerText = { "tset" };

            if (LicenseOfficerText.Length > 0)
            {
                Random rand = new Random();
                int randNumber = rand.Next(0, LicenseOfficerText.Length);
                LicenseOfficer.SendKeys(LicenseOfficerText[randNumber] + Keys.Enter);
                Console.WriteLine(LicenseOfficerText[randNumber]);
            }

            //Phone 
            Thread.Sleep(3000);
            driver.FindElement(By.Id("MOBILE")).SendKeys("Mobile Number");
            Thread.Sleep(3000);
            driver.FindElement(By.Id("NATIONALITYID")).SendKeys("Nationality Id");
            Thread.Sleep(5000);
            ...
            driver.FindElement(By.Id("NATIONALITYID")).SendKeys("Nationality");
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.Id("ADDRESS")));
            Thread.Sleep(3000);
            driver.FindElement(By.Id("ADDRESS")).Clear();
            driver.FindElement(By.Id("ADDRESS")).SendKeys("Address work");
            Thread.Sleep(5000);
            ...
            driver.FindElement(By.Id("ARNAME")).SendKeys("Name");
            driver.FindElement(By.XPath("//button[normalize-space()='EDIT']")).Click();
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//button[normalize-space()='CANCEL']")).Click();
            Thread.Sleep(5000);
