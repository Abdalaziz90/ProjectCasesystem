...
namespace JUSTDEVELOPMENT.Case_System.Cases.Existing_Procedures_Arabic
{
    [TestFixture]
    ...
    public class TestsExistingProceduresArabic
    {
        ...
        public void ExistingProceduresPage()
        {
            ...
            Thread.Sleep(7000);
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//span[@class='e-ddl e-lib e-input-group e-control-container e-control-wrapper valid']")));
            Thread.Sleep(7000);
            IWebElement caseNumber = driver.FindElement(By.XPath("//span[@class='e-ddl e-lib e-input-group e-control-container e-control-wrapper valid']"));
            caseNumber.Click();
            ...
            Thread.Sleep(7000);
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//span[@class='e-ddl e-lib e-input-group e-control-container e-control-wrapper  valid")));
            IWebElement nameLawyer = driver.FindElement(By.XPath("//span[@class='e-ddl e-lib e-input-group e-control-container e-control-wrapper  valid"));
            nameLawyer.Click();
            ...
            Thread.Sleep(7000);
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementExists(By.XPath("//span[@class='e-ddl e-lib e-input-group e-control-container e-control-wrapper  valid']")));
            IWebElement proceduresType = driver.FindElement(By.XPath("//span[@class='e-ddl e-lib e-input-group e-control-container e-control-wrapper  valid']"));
            ...
            //Date >>
            IWebElement DatePROCEDUREENTEREDAr = driver.FindElement(By.Id("DATEPROCEDUREENTERED"));
            DatePROCEDUREENTEREDAr.Clear();
            DatePROCEDUREENTEREDAr.Clear();
            DatePROCEDUREENTEREDAr.SendKeys("٣٠/١١/٢٠٢٣");

            IWebElement DEADLINEPROCEDUREAr = driver.FindElement(By.Id("DEADLINEPROCEDURE"));
            DEADLINEPROCEDUREAr.Clear();
            DEADLINEPROCEDUREAr.Clear();
            DEADLINEPROCEDUREAr.SendKeys("١٤/١٢/٢٠٢٣");

            driver.FindElement(By.Id("CONTENTPROCEDURE")).SendKeys("محتوى الاجراء");
            ...
            driver.FindElement(By.Id("CONTENTPROCEDURE")).SendKeys("محتوى");
            Thread.Sleep(5000);
            ...
            Thread.Sleep(3000);
            driver.FindElement(By.Id("CONTENTPROCEDURE")).Clear();
            driver.FindElement(By.Id("CONTENTPROCEDURE")).SendKeys("الاجراء");
            Thread.Sleep(3000);
            driver.FindElement(By.XPath("//button[contains(text(),'تعديل')]")).Click();
            Thread.Sleep(5000);
            driver.FindElement(By.XPath("//div[@class='e-footer-content']//button[@class='e-control e-btn e-lib btn btn-outline-danger'][contains(text(),'إلغاء')]")).Click();
